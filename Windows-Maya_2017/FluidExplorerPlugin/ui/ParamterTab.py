...
class SliderContainer(object):
        def __init__(self, property, propertyName, nodeName, fullPropertyName=""):
            ...
            self.groupBox_Box = QtWidgets.QWidget()
            gridLayout_Box = QtWidgets.QGridLayout()
            self.groupBox_Box.setLayout(gridLayout_Box)

            QtWidgets.QToolTip.setFont(QtGui.QFont('MS Shell', 10))
            ...
            self.lineEditMin = QtWidgets.QLineEdit(str(sliderMinValue))
            self.lineEditMax = QtWidgets.QLineEdit(str(sliderMaxValue))
            self.lineEditDefault = QtWidgets.QLineEdit(str(sliderDefValue))
            ...
            self.sliderDefValue = QtWidgets.QSlider(QtCore.Qt.Horizontal)   # delete
            ...
            self.lockImage = QtWidgets.QLabel()
...
class ParameterTab(object):
    ...
    def setupTabWidget(self):
        ...
        # --------------------------------------------------------------------------------------------------------------
        DensityBox = QtWidgets.QGroupBox()
        ...
        VelocityBox = QtWidgets.QGroupBox()
        ...
        TurbulenceBox = QtWidgets.QGroupBox()
        ...
        TemperatureBox = QtWidgets.QGroupBox()
        ...
        DynamicSimulationBox = QtWidgets.QGroupBox()
