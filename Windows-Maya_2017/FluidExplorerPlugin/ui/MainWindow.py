...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonLoadSimulation = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.pushButtonHelpMain = QtWidgets.QPushButton(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtCore.QCoreApplication.translate("MainWindow", "Fluid Explorer", None))
        self.pushButtonNewProject.setText(QtCore.QCoreApplication.translate("MainWindow", "Create Simulation", None))
        self.pushButtonLoadSimulation.setText(QtCore.QCoreApplication.translate("MainWindow", "Load Simulation", None))
        self.labelMain.setText(QtCore.QCoreApplication.translate("MainWindow", "Fluid Explorer", None))
        self.labelIcon.setText(QtCore.QCoreApplication.translate("MainWindow", "HALL", None))
